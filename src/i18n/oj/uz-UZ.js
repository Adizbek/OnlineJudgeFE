export const m = {
  ...
  Sample_Input: 'Inputga misol',
  Sample_Output: 'Outputga misol',
  Hint: 'Hint',
  Source: 'Source',
  Status: 'Holati',
  ...
  OI: 'OI',
  ACM: 'ACM',
  Underway: 'Bo`lib o`tyapti',
  Not_Started: 'Boshlanmagan',
  Ended: 'Tugagan',
  No_contest: 'Olimpiadalar yoq',
  Please_login_first: 'Please login first!',
  // ContestProblemList
  Problems_List: 'Masalalar ro`yxati',
  No_Problems: 'Masalalar mavjud emas',
  // CodeMirror.vue
  Language: 'Til',
  Theme: 'Theme',
  ...
  NavStatus: 'Urinishlar',
  Rank: 'Rank',
  ACM_Rank: 'ACM Rank',
  OI_Rank: 'OI Rank',
  About: 'Loyiha haqida',
  Judger: 'Checker haqida',
  FAQ: 'FAQ',
  ...
  Refresh: 'Yangilash',
  Back: 'Orqaga qaytish',
  No_Announcements: 'E`lonlar mavjud emas',
  // Setting.vue
  Profile: 'Profile',
  Account: 'Account',
  Security: 'Security',
  ...
  No_Account: 'Akkaunt yoqmi? Hozirroq ro`yxatdan o`ting!',
  ...
  // ProblemList.vue
  Problem: 'Masala',
  Problem_List: 'Masalalar to`plami',
  High: 'Qiyin',
  Mid: 'O`rtacha',
  Low: 'Oson',
  All: 'Barcha',
  Reset: 'Tozalash',
  Pick_One: 'Tasodifiy tanlash',
  Difficulty: 'Qiyinchiligi',
  Total: 'Urinishlar soni',
  AC_Rate: 'Qabul qilinish darajasi',
  // Register.vue
  RegisterUsername: 'Username',
  Email_Address: 'Email Address',
  RegisterPassword: 'Parol',
  Password_Again: 'Parol takrorlang',
  Captcha: 'Captcha',
  UserRegister: 'Ro`yxatdan o`tish',
  Already_Registed: 'Ro`yxatdan allaqachon o`tganmisiz? Tizimga kiring!',
  The_username_already_exists: 'username band',
  The_email_already_exists: 'email band',
  ...
  Option: 'Option',
  Mine: 'Meniki',
  Search_Author: 'Muallif bo`yicha qidiruv',
  Accepted: 'Accepted',
